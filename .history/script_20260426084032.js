    ...
    function draw() {
        ...
        if (faces.length > 0) {
            ...
            // warpX = lerp(warpX, raw_warpX, 0.4);
            // warpY = lerp(warpY, raw_warpY, 0.4);

            let rawYaw_warpX = abs(yaw) * w * 0.12;
            yawWarpX = lerp(yawWarpX, rawYaw_warpX, 0.4)

            // let yaw_tiltY = warpX * 0.3;
            // tiltX = warpX * 0.25;
            // tiltY = warpY * 0.3;
            ...
            let RawPitch_WarpY = abs(pitch) * h * 0.15;
            pitchWarpY = lerp(pitchWarpY, RawPitch_WarpY, 0.3)

            // let pitchTiltX = warpY * 0.25;
