...
function draw() {
    ...
    if (faces.length > 0) {
        ...
        beginShape();
        vertex(tlX + 50, tlY, 0, 0); // TL
        vertex(trX, trY - 50, 1, 0); // TR
        vertex(brX, brY - 50, 1, 1); // BR
        vertex(blX + 50,  blY, 0, 1); // BL
        endShape(CLOSE);

        fill(255, 0, 0);
        noStroke();

        ellipse(tlX + 50, tlY, 6, 6);
        ellipse(trX, trY - 50, 6, 6);
        ellipse(brX, brY - 50, 6, 6);
        ellipse(blX + 50, blY, 6, 6);
